//payroll-manager-dialog.jsx
const PayrollManagerDialog = ({ setShowPayrollManagerDialog, employerName, taxYear, setHeaderText }) => {
  return (
    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-md shadow-lg w-90 h-[170px]">
        <div className="flex justify-between items-center p-2 border-b">
          <h3 className="text-sm font-medium">PayrollPro</h3>
            ...
            <button
              ...
              onClick={() => {
                ...
                const newFileName = employerName
                  ? `PayrollPro - ${employerName} - ${taxYear}`
                  : `PayrollPro - ${employerName} - ${taxYear}`
